...
![Ta bort element från selektion](reflektionPngs/image.png)
...
![Kommentarer överallt](reflektionPngs/image-5.png)

Till att sätta kommentarer som visar att "nu har vi nått ett nytt stycke":

![Färre, mer givande kommentarer](reflektionPngs/image-6.png)
...
![Grupperade funktioner](reflektionPngs/image-7.png)
...
![Före refaktorisering](reflektionPngs/image-8.png)

Till en mer expanderad filstruktur med klarare syfte och uppdelat ansvar:

![Efter refaktorisering](reflektionPngs/image-9.png)
...
![Felhantering](reflektionPngs/image-10.png)
...
![Chrome wrapper](reflektionPngs/image-11.png)
...
![CleanClass](reflektionPngs/image-12.png)
